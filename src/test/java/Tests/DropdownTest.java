...
public class DropdownTest extends TestBase {
    ...
    @DisplayName("При клике на вопрос в разделе 'Вопросы о важном' отображается корректный ответ")
    public void shouldShowCorrectAnswerAfterClickingQuestion(int index, String expectedAnswer) {
        ...
        assertEquals(expectedAnswer, actualAnswer,
                "Текст ответа на вопрос #" + index + " не совпадает с ожидаемым");
    }
}